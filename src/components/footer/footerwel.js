...
export default function Footer() {
  ...
  return (
    <>
      {/*<Separator />*/}
      <div className="flex flex-col lg:flex-row bg-black h-screen w-screen p-0 py-12 font-blender-regular px-6 pt-28 footer-screen">
        <div className="w-full lg:w-[50%] flex flex-col gap-8 footer-screen-1">
          ...
          {/* <div className={sectionStyle}>
            ...
            <div className={subSectionStyle}>
              <div className={contactContainer}>
                <p className={contactNameStyle}>Dr. Sumit Srivastava</p>
        ...
        <div
          className="w-full lg:w-[50%] pr-0 lg:pr-6 flex flex-col lg:mt-0 lg:flex mt-10 footer-section-2"
          // onSubmit={handleSubmit}
        >
          <h1 className="cyberpunk glitched text-blue font-blender-bold mb-4 !text-center lg:text-start ml-8 lg:ml-0">
            Query? Get in Touch
          </h1>
          {/* <div className="mt-2 flex flex-col gap-6 mb-4">
					...
					<div className="flex mt-2 w-full justify-between">
						...
						<button
							className="cyberpunk2077 font-blender-bold px-12 py-3 "
							type="submit"
						>
							<p className=" text-lg">Contact</p>
						</button>
					</div> */}
          <div className="mt-4 md:mt-2 flex flex-col gap-6 mb-8 font-blender-medium text-lg md:text-xl w-full">
            <a
